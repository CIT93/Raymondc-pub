class FP {
    constructor(first, last, houseMembers, houseSize, foodChoice, foodSource, waterConsum, hasDishAndWasher, itemPurchase, waste, recycle, privateTrans, publicTrans, flight) {
      this.first = first;
      this.last = last;
      ...
      this.privateTransPoints = privateTrans;
